...
const BfthArena = () => {
  ...
  const {  All, BFTHArena, New, PopularGames } = t("Casino");
        ...
        <div className="w-full">
          ...
          <div className="mb-[20px] w-full rounded-[8px] mt-3 p-[7px] bg-[#0B162E] overflow-hidden border border-white/10">
            <div className="w-full flex justify-between items-center py-[10px] border-b border-white/15">
              ...
              <a href="#" className="text-white/50 text-[14px]">
                {All} (+4)
              </a>
            </div>
            ...
            {/* Game Icons Grid */}
            <div
              className="overflow-x-auto  overflow-y-hidden pt-[10px] scrollbar-hide"
              style={{
