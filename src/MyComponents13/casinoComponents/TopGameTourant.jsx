...
const TopGameTourant = () => {
    ...
    const { Context1 } = t("TournamentContext");
    const { Upcoming, PrizeFunds, Startsin, DAY, JOINNOW, Endsin } =
      t("Tournaments");
  return (
    <div>
      <div className="w-[100%] pl-[16px] pr-[16px]">
        <div className="w-[100%] mb-[24px] mt-5">
          <h2
            className="text-[12px] leading-[14px] text-[rgba(255,255,255,1)]
                  font-[400] mb-[16px] text-shadow-glow uppercase"
          >
            {Context1}
          </h2>
          ...
          <div className="w-[100%] flex gap-[8px]">
            <div className="relative w-[100%] min-w-[194px] max-w-[194px] ">
              <button
                className="absolute h-[19px] top-[5px] lef-[-5px] bg-[rgba(85,191,226,1)]
                           flex items-center z-1 pt-[8px] pb-[8px] text-[rgba(255,255,255,1) text-[10px] px-1"
              >
                {Upcoming}
              </button>
            ...
            <div className="relative w-[100%] p-[6px] bg-[rgba(255,255,255,.05)] rounded-[4px] border border-[rgba(255,255,255,.05)]">
              ...
              <span></span>
              <div className="w-[100%]">
                <p className="mb-[4px] text-[12px] leading-[14px] text-center text-[rgba(255,255,255,.6)]">
                  {PrizeFunds}
                </p>
                <p
                  className="text-[14px] leading-[16px] font-bold text-shadow-[0_0px_4px_rgb(85_191_226_1)]
                ...
                <div className="mb-[8px] w-[100]">
                  ...
                  <div className="flex justify-center w-[100%]">
                    <div className="relative pe-[4px] flex flex-col items-center">
                      <span className="text-[14px] leading-[16px] text-[rgba(255,255,255,1)]">
                        00 :
                      </span>
                      <p className="text-[8px] leading-2 text-[rgba(255,255,255,1)]">
                        {DAY}
                      </p>
                    </div>
              ...
              <div className="flex justify-center items-center w-[100%] pl-2 pr-2">
                <button
                  className="bg-[rgba(85,191,226,1)] text-[rgba(0,0,0,1)] h-[32px]
                               w-[100%] rounded-[4px] text-[14px] leading-[16px] pl-[15px] pe-[15px]"
                >
                  {JOINNOW}
                </button>
              </div>
