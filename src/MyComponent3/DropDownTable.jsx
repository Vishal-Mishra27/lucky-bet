...
export default function LeagueMatches() {
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-mainBg text-white rounded overflow-auto">
      {matchData.map((league, idx) => (
        <div key={idx} className="">
          <div
            onClick={() => setOpenLeague(openLeague === idx ? null : idx)}
            className="flex items-center justify-between px-4 py-1 cursor-pointer bg-bg1 hover:bg-[#1c253f]"
          >
          ...
          {openLeague === idx && league.matches.length > 0 && (
            <div className="bg-[#101a33] px-2 py-2">
              {league.matches.map((match, mIdx) => (
                <div
                  key={mIdx}
                  className="bg-bg1 rounded-md pl-2 pr-2 pt-2 pb-0 mb-3 shadow-sm"
                >
                  {/* Teams and scores */}
                  ...
                  {/* Halftime */}
                  <div className="text-[12px] text-hederColor2 mt-1">
                    {match.halftime}
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-1 text-[12px] text-hederColor2">
