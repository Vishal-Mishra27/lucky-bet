      ...
      <div className="p-4 w-full flex flex-col gap-4">
        ...
        <div className="bg-bg1 w-full rounded p-4">
          ...
          <div className="flex items-center justify-end mt-2">
            <button className="flex items-center text-nowrap bg-bg4 hover:bg-bg5 text-bg2 rounded-[0.25rem] text-xs w-60 justify-center py-2.5">
              SHOW
            </button>
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          <div className=" max-h-[600px] pr-1">
            {mockTransactions.map((trans, index) => (
              <div
                key={index}
                className="border-b-[1px] border-mainBg overflow-x-auto hide-scrollbar w-full"
              >
                {/* Horizontal scrollable row */}
                <div className="min-w-max grid grid-cols-4 text-xsm bg-bg2 cursor-pointer whitespace-nowrap">
                  ...
                  <div className="col-span-1 flex items-center p-1.5">
                    {trans?.type}
                  </div>
                  <div className="col-span-1 flex items-center text-yellow p-1.5">
                    {trans?.amount}
                  </div>
                  <div className="col-span-1 flex items-center justify-between px-1 text-green p-1.5">
                    {trans?.finalBalance}
                ...
                {openEntryIndex === index && trans.entries.length > 0 && (
                  <div className="bg-[#0D182F] px-20 py-2 text-xsm text-white">
                    <div className="grid grid-cols-2 pb-1 mb-1 bg-[#313A4E]">
                      <div className="font-semibold text-center border-r-[1px] border-mainBg">
                        Date
                      </div>
                    ...
                    {trans.entries.map((entry, idx) => (
                      ...
                      >
                        <div className="text-center border-r-[1px] border-mainBg">
                          {entry.date}
                        </div>
